...
import 'update_basico_contribuyente_model.dart';
export 'update_basico_contribuyente_model.dart';

class UpdateBasicoContribuyenteWidget extends StatefulWidget {
  const UpdateBasicoContribuyenteWidget({
    Key? key,
    this.rif,
  }) : super(key: key);
  ...
  @override
  _UpdateBasicoContribuyenteWidgetState createState() =>
      _UpdateBasicoContribuyenteWidgetState();
}

class _UpdateBasicoContribuyenteWidgetState
    extends State<UpdateBasicoContribuyenteWidget> {
  late UpdateBasicoContribuyenteModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UpdateBasicoContribuyenteModel());
  }
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<ApiCallResponse>(
      ...
      builder: (context, snapshot) {
        ...
        final updateBasicoContribuyenteGetFulcrumContribuyentesByRifResponse =
            snapshot.data!;
        return Scaffold(
          key: scaffoldKey,
                                                      ...
                                                      child: Padding(
                                                        ...
                                                        child: TextFormField(
                                                          controller: _model
                                                            ...
                                                            text:
                                                                '${GetFulcrumContribuyentesByRifCall.rifLetter(
                                                              updateBasicoContribuyenteGetFulcrumContribuyentesByRifResponse
                                                                  .jsonBody,
                                                            ).toString()}${GetFulcrumContribuyentesByRifCall.rif(
                                                              updateBasicoContribuyenteGetFulcrumContribuyentesByRifResponse
                                                                  .jsonBody,
                                                            ).toString()}',
                                                          ),
