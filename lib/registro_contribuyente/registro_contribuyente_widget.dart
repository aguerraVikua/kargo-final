...
import 'registro_contribuyente_model.dart';
export 'registro_contribuyente_model.dart';

class RegistroContribuyenteWidget extends StatefulWidget {
  const RegistroContribuyenteWidget({Key? key}) : super(key: key);

  @override
  _RegistroContribuyenteWidgetState createState() =>
      _RegistroContribuyenteWidgetState();
}

class _RegistroContribuyenteWidgetState
    extends State<RegistroContribuyenteWidget> {
  late RegistroContribuyenteModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RegistroContribuyenteModel());
                                            ...
                                            onPressed: () async {
                                              ...
                                              final taxpayersCreateData = {
                                                ...createTaxpayersRecordData(
                                                  ...
                                                  fotoDeLaFachada:
                                                      _model.uploadedFileUrl2,
                                                  estadoDelEstablecimiento: _model
                                                      .switchListTileAbiertoValue
                                                      ?.toString(),
                                                  ...
                                                  areaTerrenoCatastral: _model
                                                      .areaterrenoController
                                                      .text,
                                                  areaConstruccionCatastral: _model
                                                      .areaconstructccionController
                                                      .text,
                                                  ...
                                                  seEncuentraVencidaActividadEconomica:
                                                      _model.vencidaValue
                                                          ?.toString(),
                                                  codigoLicenciaActEconomica: _model
                                                      .codigodelicenciaController
                                                      .text,
